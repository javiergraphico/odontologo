    ...
    <section className={styles.equipo}>
      <div className="contenedor">
          ...
          <div className={styles.card}>
            ...
            <div className={styles.conten_info}>
              ...
              <div className={styles.redes}>
                <Link
                  className={styles.redes_icons}
                  href="https://www.behance.net/javiergraphico"
                  target="_blank"
                ...
                <Link
                  className={styles.redes_icons}
                  href="https://www.linkedin.com/in/javier-tovar-46687a177/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <div className={styles.conten_btn}>
          <Boton href={href}>{"Solicitar Cita"}</Boton>
        </div>
      </div>
    </section>
  );
